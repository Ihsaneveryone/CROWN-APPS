/**
 * Google Apps Script - Crown Daily Indicators (MASTER)
...
var CASHIER_INDICATORS = {
  'cashier-sales-id': 29,
  'cashier-trx': 30,
  'cashier-new-member': 31,
  'cashier-instant-upgrade': 32
};
