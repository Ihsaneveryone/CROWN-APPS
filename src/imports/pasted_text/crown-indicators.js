/**
 * =====================================================================
 * CROWN DAILY INDICATORS - MASTER SPREADSHEET APPS SCRIPT (FIXED)
 * =====================================================================
 *
 * FIX: Foto upload ke Drive tapi kolom J kosong
 *
 * DEPLOYMENT:
...
function doGet(e) {
  return ContentService
    .createTextOutput(JSON.stringify({
      status: 'ok',
      message: 'Crown Daily Indicators - Master API (FIXED)',
      version: '1.1',
...
function updateIndicators(data, spreadsheetId) {
  try {
    ...
    var headers = ['branchId', 'id', 'name', 'type', 'targetValue', 'targetPhotos', 'weight', 'icon', 'role', 'createdAt'];
